from src.model import configSimulation, simulationLoopUnsafe_nn
import jax
import sys
import time
import os
...
sim_loop_old_jit = partial(jit, static_argnums=(0, 1, 13))(simulationLoopUnsafe_nn)
...
def simLoopWrapper(nn_params):
    ...
    return jnp.sqrt(jnp.sum(jnp.square((P-P_t))))
